...
onmouseout="this.style.backgroundColor='#4A7562';" data-bs-toggle="modal" data-bs-target="#createItemModal">
    Create Item
</button>
            ...
            <div class="modal-body">
                <div style="">
                    ...
                    <form action="{{ route('item.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn w-100" style="background-color: #4A7562; color:white" onmouseover="this.style.backgroundColor='#3f5d48';" 
                        onmouseout="this.style.backgroundColor='#4A7562';">Create Item</button>
                    </form>
                </div>
            </div>
        </div>
